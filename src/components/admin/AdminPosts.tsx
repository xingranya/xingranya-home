    ...
    <div className="admin-page-body space-y-5">
      ...
      <div className="admin-card">
            ...
            <div className="flex items-center bg-slate-100 dark:bg-slate-800/80 p-0.5 rounded-lg border border-slate-200 dark:border-slate-700">
              <button
                ...
                className={`px-2.5 py-1 rounded text-[11px] font-medium ${
                  selectedStatus === 'all'
                    ? 'bg-white dark:bg-slate-900 text-sakura-600 shadow-2xs font-semibold'
                    : 'text-slate-500'
                }`}
              >
                全部 ({posts.length})
              ...
              return (
                <button
                  ...
                  className={`px-2 py-0.5 rounded-full text-[11px] font-mono transition-colors ${
                    active
                      ? 'bg-sakura-500 text-white font-medium shadow-xs'
        ...
        {selectedSlugs.length > 0 && (
          <div className="p-3 px-4 bg-sakura-50 dark:bg-sakura-950/80 border-t border-sakura-200 dark:border-sakura-800/80 flex flex-wrap items-center justify-between gap-2 text-xs text-sakura-950 dark:text-sakura-100 animate-in fade-in">
            ...
            <table className="admin-table">
              ...
              <tbody>
                {filteredPosts.map((post) => {
                  ...
                  return (
                    <tr key={post.slug} className={isSelected ? 'bg-sakura-50/50 dark:bg-sakura-950/40' : ''}>
                      <td className="text-center">
                        <button
                          onClick={() => handleToggleSelect(post.slug)}
                          className="p-1 text-slate-400 hover:text-sakura-600"
                        >
                          {isSelected ? (
                            <CheckSquare className="w-4 h-4 text-sakura-600" />
                          ) : (
                      ...
                      <td>
                        <div className="space-y-0.5 max-w-sm">
                          <div
                            ...
                            className="font-semibold text-slate-900 dark:text-slate-100 hover:text-sakura-600 cursor-pointer truncate"
                          >
                            {post.title}
                          </div>
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between gap-2">
                      <span className="text-[11px] font-mono text-sakura-600 dark:text-sakura-400 bg-sakura-50 dark:bg-sakura-950/60 px-2 py-0.5 rounded">
                        {post.category}
                      </span>
                    ...
                    <h3
                      onClick={() => onOpenEditor('post', post.slug)}
                      className="font-bold text-sm text-slate-900 dark:text-slate-100 hover:text-sakura-600 cursor-pointer line-clamp-2"
                    >
                      {post.title}
                    </h3>
