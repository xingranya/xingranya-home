        ...
        <article className="paper-sheet-realistic p-6 sm:p-10 md:p-12 font-sans space-y-10 my-4 sm:my-8 text-slate-800 dark:text-slate-200">
          ...
          <header className="text-center pb-8 border-b border-slate-200/70 dark:border-slate-800/70 space-y-3">
            <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-xs bg-slate-100 dark:bg-slate-800 text-[11px] font-mono tracking-wider text-slate-600 dark:text-slate-400">
              <BookOpen className="w-3 h-3 text-sakura-600 dark:text-sakura-400" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {sections.map((sec) => (
                <Link
                  key={sec.path}
                  href={sec.path}
                  className="group block p-4 rounded bg-slate-50/70 dark:bg-slate-900/40 border border-slate-200/60 dark:border-slate-800/60 hover:border-sakura-300/80 dark:hover:border-sakura-800/80 transition-all shadow-2xs hover:shadow-sm"
                >
                  <div className="flex items-baseline justify-between">
                    <div className="flex items-baseline space-x-2">
                      <span className="font-serif font-bold text-sm text-slate-900 dark:text-slate-100 group-hover:text-sakura-600 dark:group-hover:text-sakura-400 transition-colors">
                        {sec.name}
                      </span>
                  ...
                  <div className="mt-3 text-[11px] font-mono text-sakura-600 dark:text-sakura-400 opacity-0 group-hover:opacity-100 transition-opacity flex items-center space-x-1">
                    <span>访问该频道</span>
            ...
            <div className="p-4 rounded-xs bg-slate-50/70 dark:bg-slate-900/40 border border-slate-200/60 dark:border-slate-800/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
              <div className="space-y-0.5">
                <div className="font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                  <Sparkles className="w-3.5 h-3.5 text-sakura-600 dark:text-sakura-400" />
              ...
              <div className="flex items-center gap-2 font-mono text-xs shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-xs bg-sakura-50 dark:bg-sakura-950/50 border border-sakura-200/60 dark:border-sakura-800/60 text-sakura-700 dark:text-sakura-300 hover:bg-sakura-100 dark:hover:bg-sakura-900/50 transition-colors"
                >
                  <span>feed.xml</span>
                  <ExternalLink className="w-3 h-3 opacity-60" />
                </a>
